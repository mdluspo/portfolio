...
PrinceJS.Kid = function (game, level, location, direction, room) {
  ...
  this.actionKeys = [
    this.game.input.keyboard.addKey(74),
    this.game.input.keyboard.addKey(75),
  ];
...
PrinceJS.Kid.prototype.keyL = function () {
  return this.cursors.left.isDown || this.wasd.left.isDown || this.pointerL() || PrinceJS.Utils.gamepadLeftPressed(this.game);
};

PrinceJS.Kid.prototype.keyR = function () {
  return this.cursors.right.isDown || this.wasd.right.isDown || this.pointerR() || PrinceJS.Utils.gamepadRightPressed(this.game);
};

PrinceJS.Kid.prototype.keyU = function () {
  return this.cursors.up.isDown || this.wasd.up.isDown || this.pointerU() || PrinceJS.Utils.gamepadUpPressed(this.game);
};

PrinceJS.Kid.prototype.keyD = function () {
  return this.cursors.down.isDown || this.wasd.down.isDown || this.pointerD() || PrinceJS.Utils.gamepadDownPressed(this.game);
};

PrinceJS.Kid.prototype.keyS = function () {
  return (
    this.shiftKey.isDown ||
    this.game.input.keyboard.isDown(74) ||
    this.game.input.keyboard.isDown(75) ||
