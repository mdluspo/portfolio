...
const GAMES: Array<{
  ...
  },
  {
    ...
    meta: "J2ME / JAR / Nokia",
    status: "READY",
    src: "/games/j2me-web/run.html?app=bounce&mobile=1&fractionScale=1&v=9",
    accent: "bg-[#ff6b6b]",
    label: "BOU",
    thumbnail: "/bounce.jpg",
    controls: ["Arrow buttons: move", "Up: jump", "OK: select", "L / R: soft keys", "Full: toggle integer scaling"],
  },
  {
    id: "diamond",
    title: "Diamond Rush",
    meta: "J2ME / JAR / K790",
    status: "READY",
    src: "/games/j2me-web/run.html?app=diamond&mobile=1&fractionScale=1&v=9",
    accent: "bg-[#70e1c8]",
    label: "DR",
    thumbnail: "/diamond_rush.jpg",
    controls: ["Arrow buttons: move", "OK: select / action", "L / R: soft keys", "Esc: back", "Full: toggle integer scaling"],
  },
];
