...
const GAMES: Array<{
  ...
  },
  {
    ...
    meta: "J2ME / JAR / Nokia",
    status: "READY",
    src: "/games/j2me-web/run.html?app=bounce&mobile=1&fractionScale=1&reinstall=1&v=13",
    accent: "bg-[#ff6b6b]",
    label: "BOU",
  ...
  },
  {
    ...
    meta: "J2ME / JAR / K790",
    status: "READY",
    src: "/games/j2me-web/run.html?app=diamond&mobile=1&fractionScale=1&reinstall=1&v=13",
    accent: "bg-[#70e1c8]",
    label: "DR",
